...
export const metadata = {
  title: "Tax Resources & Tools - GG Tax Services",
  description: "Free tax tools, calculators, forms, and resources for tax preparation.",
};
  ...
  return (
    <div className="min-h-screen bg-gray-900 py-12 px-4 md:px-8">
      <div className="max-w-6xl mx-auto">
        {/* Header */}
        <h1 className="text-4xl md:text-5xl font-bold text-green-400 mb-6">Tax Resources & Tools</h1>
        <p className="text-gray-300 text-lg mb-12 leading-relaxed">
          We've compiled free resources and tools to help you prepare for tax season, understand tax concepts, 
        ...
        <section className="mb-16">
          <h2 className="text-2xl font-bold text-white mb-8">Available Resources</h2>
        ...
        <section className="bg-gray-800 border border-gray-700 rounded-lg p-8 mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <Link href="/guides" className="text-green-400 hover:text-green-300 font-semibold">
                View guides →
              </Link>
            </div>
            <div>
        ...
        <section className="text-center">
          ...
          <p className="text-gray-300 mb-6">
            Resources are helpful, but sometimes you need expert guidance. Schedule a consultation 
