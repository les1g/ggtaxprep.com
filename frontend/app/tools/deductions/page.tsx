      ...
      <div className="max-w-6xl mx-auto space-y-12">
        ...
        <header className="space-y-4">
          ...
          <p className="text-gray-300 text-lg leading-relaxed">
            Start with federal deductions/credits (IRS), then apply
            Arizona-specific deductions/credits. Compare standard vs. itemized
            at both levels to maximize savings. Use the Print button to save as
            PDF.
          </p>
          <button
        ...
        <section className="bg-gray-800 border border-gray-700 rounded-lg p-8 space-y-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="list-disc list-inside text-gray-300 space-y-2">
              <li>
                Educator Expenses: Up to $300 ($600 MFJ if both educators)
              </li>
              <li>Student Loan Interest: Up to $2,500 (income limits apply)</li>
              <li>
                IRA Contributions: Deductible based on income/plan coverage
              </li>
              <li>HSA Contributions: For high-deductible health plans</li>
              <li>
                Self-Employed: Health insurance premiums; 50% SE tax;
                SEP/SIMPLE/solo 401(k); home office; ordinary/necessary biz
                expenses
              </li>
          ...
          <div className="space-y-4">
            ...
            <ul className="list-disc list-inside text-gray-300 space-y-2">
              ...
              <li>
                Education Credits: American Opportunity (AOTC), Lifetime
                Learning (LLC)
              </li>
        ...
        <section className="bg-gray-800 border border-gray-700 rounded-lg p-8 space-y-8">
          ...
          <div className="space-y-3">
            ...
            <p className="text-gray-300">
              Claimable even if you itemize federally; extra deduction for age
              65+.
            </p>
          ...
          <div className="space-y-3">
            <h3 className="text-2xl font-bold text-white">
              Itemized (Based on Fed Schedule A, with AZ adjustments)
            </h3>
            <ul className="list-disc list-inside text-gray-300 space-y-2">
              ...
              <li>
                State, local, real estate, personal property taxes (adjust if
                claiming AZ charitable credits)
              </li>
            </ul>
          </div>
          ...
          <div className="space-y-3">
            ...
            <ul className="list-disc list-inside text-gray-300 space-y-2">
              ...
              <li>
                Retirement benefits: federally taxable Social Security &
                railroad retirement
              </li>
              <li>
                Adoption expenses: Up to $3,000 (year adoption order granted)
              </li>
              <li>Long-term care insurance premiums (if qualifying)</li>
              <li>
                529 Plan contributions: Up to $2,000 (single) / $4,000 (MFJ)
              </li>
            </ul>
          </div>
        ...
        <section className="bg-gray-800 border border-green-400 rounded-lg p-8">
          ...
          <ol className="list-decimal list-inside text-gray-300 space-y-2">
            ...
            <li>
              Compare standard vs. itemized at both federal and state levels.
            </li>
            <li>
              Choose the combination that yields the greatest overall tax
              benefit.
            </li>
          </ol>
        </section>
        ...
        <section className="bg-gradient-to-r from-green-900/30 to-green-800/30 border border-green-400/50 rounded-lg p-8 text-center">
          ...
          <p className="text-gray-300 mb-6">
            Book a consultation and we’ll map the best deduction and credit
            strategy for you.
          </p>
