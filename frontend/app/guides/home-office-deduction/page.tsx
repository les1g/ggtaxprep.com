    ...
    <div className="min-h-screen bg-gray-900 py-12 px-4 md:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <header className="mb-8">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-green-400 mb-4">Home Office Deduction Guide</h1>
        </header>

        <article className="bg-gray-800 border border-gray-700 rounded-lg p-8 mb-12 space-y-6">
          <section>
            <p className="text-gray-300 leading-relaxed">
              Working from home? You may qualify for a home office deduction. With more people working remotely, 
              this deduction has become increasingly valuable. Here's what you need to know.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-bold text-green-400 mb-3">Requirements</h2>
            ...
            <div className="bg-gray-700/50 border border-gray-600 rounded-lg p-4 mt-4">
              <p className="text-gray-300 text-sm">
                <strong>Note:</strong> You cannot use this deduction if you work from a shared space or occasionally work from home.
              </p>
            </div>
          </section>

          <section>
            <h2 className="text-2xl font-bold text-green-400 mb-3">Two Calculation Methods</h2>
            <div className="space-y-4 mb-4">
              <div className="bg-gray-700/50 border border-gray-600 rounded-lg p-4">
                <h4 className="font-semibold text-green-400 mb-2">Simplified Method</h4>
                <p className="text-gray-300 text-sm mb-2">
                  <strong>$5 per square foot</strong>, up to 300 sq ft (maximum $1,500/year)
                </p>
                <p className="text-gray-300 text-sm">
              ...
              <div className="bg-gray-700/50 border border-gray-600 rounded-lg p-4">
                <h4 className="font-semibold text-green-400 mb-2">Regular Method</h4>
                <p className="text-gray-300 text-sm mb-2">
          ...
          <section>
            <h2 className="text-2xl font-bold text-green-400 mb-3">Deductible Expenses (Regular Method)</h2>
            <p className="text-gray-300 leading-relaxed mb-4">
          ...
          <section>
            <h2 className="text-2xl font-bold text-green-400 mb-3">Example Calculation</h2>
            <div className="bg-gray-700/50 border border-gray-600 rounded-lg p-4">
              <p className="text-gray-300 text-sm mb-3">
                <strong>Home details:</strong> 2,000 sq ft home, 200 sq ft home office (10%)
              </p>
              <p className="text-gray-300 text-sm mb-2">
        ...
        <section className="bg-gradient-to-r from-green-900/30 to-green-800/30 border border-green-400/50 rounded-lg p-8 text-center">
          <h2 className="text-2xl font-bold text-white mb-4">Maximize Your Home Office Deduction</h2>
