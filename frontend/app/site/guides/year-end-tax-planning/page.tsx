      ...
      <div className="max-w-6xl mx-auto mb-12">
        ...
        <article className="bg-gray-800 border border-gray-700 rounded-lg p-8 mb-12 space-y-6">
          <section>
            <p className="text-gray-300 leading-relaxed">
              ...
              planning can save you thousands of dollars. Here are strategic
              moves you can make before December 31st to minimize your tax
              liability.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-300 leading-relaxed mb-4">
              If you&apos;re close to itemizing, consider bunching charitable
              donations or medical expenses into one year to exceed the standard
              deduction threshold.
            </p>
            <div className="bg-gray-700/50 border border-gray-600 rounded-lg p-4">
              <p className="text-gray-300 text-sm mb-2">
                <strong>Example:</strong> Standard deduction is $27,700. If you
                have $26,000 in deductions, make additional charitable donations
                of $2,000 to exceed the threshold.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-300 leading-relaxed mb-4">
              Sell underperforming investments to offset capital gains from
              winners. This can reduce your overall capital gains tax
              significantly.
            </p>
            <div className="bg-gray-700/50 border border-gray-600 rounded-lg p-4">
              <p className="text-gray-300 text-sm">
                <strong>⚠️ Wash Sale Rule:</strong> Don&apos;t buy back the same
                investment within 30 days of selling at a loss.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-300 leading-relaxed mb-4">
              Make charitable donations before December 31 to deduct them in the
              current tax year. Keep receipts and documentation.
            </p>
          ...
          <section>
            ...
            <p className="text-gray-300 leading-relaxed mb-4">
              Self-employed? Purchase business equipment before year-end to
              deduct it in the current year:
            </p>
            <ul className="list-disc list-inside text-gray-300 space-y-2">
        ...
        <section className="bg-gradient-to-r from-green-900/30 to-green-800/30 border border-green-400/50 rounded-lg p-8 text-center">
          ...
          <p className="text-gray-300 mb-6">
            Our tax experts can review your situation and develop a customized
